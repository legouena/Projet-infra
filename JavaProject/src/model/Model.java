...
public class Model {
	...
	public Model() {
		...
		// Mocking data
		User l_user1 = new User(1, "administrateur", "arian", "mail1", 
								"password1", "14/01/2023", "15/01/2023", (float)2.56);
		User l_user2 = new User(2, "utilisateur", "cloard", "mail2", 
				"password2", "14/01/2023", "15/01/2023", (float)2.56);
		User l_user3 = new User(3, "utilisateur", "bisonfuté", "mail3", 
				"password3", "14/01/2023", "15/01/2023", (float)2.56);
		User l_user4 = new User(4, "utilisateur", "darde", "mail4", 
		...
		Game l_game1 = new Game(1, "Apex", "16/01/2023", "15/01/2023",
								"jeux d'horreur", "Blizzard", (float)2.5 );
		Game l_game2 = new Game(2, "battlefield", "16/01/2023", "15/01/2023",
				"jeux d'horreur", "Blizzard", (float)2.5 );
		Game l_game3 = new Game(3, "game3", "16/01/2023", "15/01/2023",
				"jeux d'horreur", "Blizzard", (float)2.5 );
		Game l_game4 = new Game(4, "crossroad", "16/01/2023", "15/01/2023",
				"jeux d'horreur", "Blizzard", (float)2.5 );
		Game l_game5 = new Game(5, "dalton", "16/01/2023", "15/01/2023",
				"jeux d'horreur", "Blizzard", (float)2.5 );
		games.add(l_game1);
		games.add(l_game2);
		games.add(l_game3);
