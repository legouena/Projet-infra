...
import controller.ActionSortAscending;
import controller.ActionSortDescending;
import model.Game;
import model.Model;
import model.Review;
import model.User;
...
public class GamesList extends JPanel{
	...
	private JButton sort_ascending;
	private JButton sort_descending;
	...
	private void initComponents () {
		...
		ActionSortAscending l_action_sort_asc = new ActionSortAscending(this);
		this.sort_ascending = new JButton(l_action_sort_asc) ;
		this.sort_ascending.setText(ActionSortAscending.NOM_ACTION);
		this.sort_ascending.setBackground(Color.orange);
		this.add(this.sort_ascending);
		
		// Button sort descending
		ActionSortDescending l_action_sort_desc = new ActionSortDescending(this);
		this.sort_descending = new JButton(l_action_sort_desc) ;
		this.sort_descending.setText(ActionSortDescending.NOM_ACTION);
		this.sort_descending.setBackground(Color.orange);
		this.add(this.sort_descending);
...
//		}
  	...
  	public void sortDescOrder() {
        ...
        Collections.sort(l_games, Collections.reverseOrder());
